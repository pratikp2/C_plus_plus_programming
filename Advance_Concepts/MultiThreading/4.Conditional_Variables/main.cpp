...
void *watch_count(void *t)
{
    ...
    // Lock mutex and wait  for signal.  Note that the pthread_cond_wait routine will automatically and atomically unlock
    // mutex while it waits. Also, note that if COUNT_LIMIT is reached before this routine is run by the waiting thread, the
    // loop will be skipped to prevent pthread_cond_wait from never returning.
