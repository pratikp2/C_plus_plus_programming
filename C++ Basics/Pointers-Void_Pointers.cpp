...
int main() {
    ...
    //cout <<"Value for *ptr                        : "<<*ptr<<endl;    //Telling compiler to dereference a void* but 
                                                                        // since it is a void * compiler has no idea
                                                                        // to what the memory at ptr is meant to look
                                                                        // like.Is it a int or float or char memory ?
    ptr = &a;
