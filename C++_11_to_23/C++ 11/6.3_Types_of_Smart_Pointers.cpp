...
Address Of the First auto_ptr  :    0x5573ba2fbeb0
Address Of the Second auto_ptr :    0x5573ba2fbeb0
Address Of the First auto_ptr after second auto_ptr is created :    0


Address Of the First unique_ptr  :    0x5573ba2fc2e0
Address Of the Second unique_ptr :    0x5573ba2fc2e0
Address Of the First unique_ptr after second unique_ptr is created :    0


Address Of the First shared_ptr  :    0x5573ba2fc300
Address Of the Second shared_ptr :    0x5573ba2fc300
Address Of the First shared_ptr after second shared_ptr is created :    0x5573ba2fc300
Pointers Count Pointing to the address of the First Pointer :    2
Pointers Count Pointing to the address of the Second Pointer :    2
Address Of the First Pointer After resetting it :    0
Address Of the Second Pointer After resetting first Pointer :    0x5573ba2fc300
Pointers Count Pointing to the address of the Second Pointer :    1


Class Object_1 is created.
Class Object_2 is created.
Calling Object is linked with Object_2
Calling Object is linked with Object_1
Class Object_2 is destroyed.
Class Object_1 is destroyed.
